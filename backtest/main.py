...
conditions = {
    ...
    'closed_green': ['x == True'],
    'dollar_volume': ['x > 100000000'],
    'duration_above_SMA20_d': ['x > 1', 'x > 5'],
    'long_%': ['x < 60', 'x < 80'],
    'longs_24h_chg%': ['x < -1'],
    'relative_volume': ['x > 2'],
    'week_end': ['x == False'],
    'duration_above_SMA20_h1': ['x > 0', 'x > 5', 'x > 10', 'x > 20']
}
...
target_path = './data/dataset/results_breakout_2020.csv'
...
def evaluer_conditions_vectorisees(df, conditions):
    print('evaluer_conditions_vectorisees')

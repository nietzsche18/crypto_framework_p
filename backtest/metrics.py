...
def replace_commas(input_string):
    # Tracker pour savoir si on est à l'intérieur de parenthèses
    ...
    for char in input_string:
        ...
        # Remplacer les virgules selon le contexte
        if char == ',':
            if in_parentheses:
                result.append(':')  # Remplacer par ':' si dans les parenthèses
            else:
                result.append(' ')  # Remplacer par ';' si hors des parenthèses
        else:
            result.append(char)
